...
from danone.models import EstudoDanone, LinhaFaturamento
...
def carregar_estudo(caminho: Path | None = None) -> EstudoDanone:
    ...
    ranking = _calcular_market_share(_extrair_bloco_ranking(df_ranking, COL_LAB_ESQ))
